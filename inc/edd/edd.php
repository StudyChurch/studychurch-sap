 ...
 * @since 1.0
 */
require_once( get_stylesheet_directory() . '/inc/admin/metabox/metabox.php' );
 ...
 * @since 1.0
 */
require_once( get_stylesheet_directory() . '/inc/widgets/widget-pricing-table-variable.php' );
require_once( get_stylesheet_directory() . '/inc/widgets/widget-pricing-table-standard.php' );
...
function checkout_edd_scripts() {
	...
	// EDD javascript
	wp_enqueue_script( 'checkout-edd-js', get_stylesheet_directory_uri() . '/js/edd.js', array( 'jquery' ), '1.0', true );
