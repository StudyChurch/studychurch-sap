...
function checkout_start_load_admin_scripts() {
	...
	wp_enqueue_script( 'getting-started', get_stylesheet_directory_uri() . '/inc/admin/getting-started/getting-started.js', array( 'jquery' ), '1.0.0', true );

	// Fitvids responsive videos
	wp_enqueue_script( 'getting-started-fitvid', get_stylesheet_directory_uri() . '/js/jquery.fitvids.js', array( 'jquery' ), '1.1', true );

	// Getting Started styles
	wp_register_style( 'getting-started', get_stylesheet_directory_uri() . '/inc/admin/getting-started/getting-started.css', false, '1.0.0' );
